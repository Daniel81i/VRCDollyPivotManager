...
**パラメータ 0〜1 は一周ではなく「右→奥→左」の半周に割り当てています。**
...
手前側の半周は **Tilt の符号を反転**すれば出せます（円が 180° ひっくり返るため）。
...
2026-08-09 に Tilt ±30°/+15° × Low Point 0/50/100% の5本を実測し、上の表と 0.6 度以内で一致することを確認済みです。
